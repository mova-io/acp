...
const ready = { ...draft, _raw: { proposal_snapshot_ids: ['snapshot'], source_revision: 1, decision_version: 1 } }
it('separates incomplete drafts from actionable judgment without inventing automatic work', () => {
 ...
 for (const row of [{ ...ready, stale: true }, { ...ready, after: '' }, { ...ready, _raw: { ...ready._raw, finding_count: 2 } }, { ...ready, canApprove: false }]) expect(responsibility(row)).toBe('check')
