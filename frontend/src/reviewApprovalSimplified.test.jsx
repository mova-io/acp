...
const ready = (id, extra = {}) => ({ id, file: `${id}.docx`, ruleId: '1.1.1', title: 'Image description', kind: 'ai-draft', aiAssisted: true, hasProposal: true, after: 'A useful image description', _raw: { decision_version: 1, source_revision: 'source', proposal_snapshot_ids: [`proposal-${id}`], corrected_artifact: 'none', proposal_digest: 'digest-test' }, ...extra })
