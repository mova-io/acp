...
const proposal={id:'ai',file:'a.docx',status:'pending',hasProposal:true,after:'Alternative text',proposals:[{proposed_value:'Alternative text',source:'AI',model:'vision',model_call_id:'call'}],_raw:{corrected_artifact:'none',finding_count:1,proposal_snapshot_ids:['snapshot'],source_revision:'source',decision_version:0}}
const manual={id:'manual',file:'b.docx',rule_id:'1.3.1',status:'pending',manual:true,hasProposal:false,title:'Requires human input'}
const admitted={...proposal,_raw:{corrected_artifact:'none',...proposal._raw,automatic_approval:{run_id:'batch',source_revision:'source',state:'checking'}}}
